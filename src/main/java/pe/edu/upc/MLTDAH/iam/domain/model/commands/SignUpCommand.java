...
public record SignUpCommand(String firstName, String lastName, String dni, Date birthDate, String photo, String email, String password, Long institutionId, String role) {
