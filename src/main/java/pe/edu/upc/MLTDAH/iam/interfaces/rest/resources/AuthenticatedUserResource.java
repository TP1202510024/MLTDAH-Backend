...
public record AuthenticatedUserResource(String firstName, String lastName, String dni, Date birthDate, String photo, String email, String password, InstitutionResource institutionResource, String token) {
